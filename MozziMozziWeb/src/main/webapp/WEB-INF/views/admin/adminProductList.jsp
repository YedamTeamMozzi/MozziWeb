      ...
      <body>
        ...
        <div id="main" style="padding-top:30px">
          <div id="btn_manager_wrapper">
            ...
            <div id="manager">
              <h1 class="title" style="padding: 30px; border: none;">상품목록</h1>
              ...
              <form name="rFrm" id="rFrame" action="goods_masterProc.jsp" enctype="multipart/form-data">
                <table class="mgr_table horHead" style="text-align: center;">
                  ...
                  <tbody>
                    <c:forEach var="adminProd" items="${list}">
                      <tr class="tr_hover" onclick="location.href='productManage.do?dduck=${adminProd.prodCode}'">
                        <td>${adminProd.prodCode}</td>
                ...
                <div class="submit_wrapper">
                  ...
                  <input class="btn" type="button" value="추가" onclick="location.href='adminProductAdd.do'" />
