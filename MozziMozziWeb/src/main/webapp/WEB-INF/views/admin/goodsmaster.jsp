					...
					<div id="manager_btn_wrapper">
						<ul>
							...
							<a href="memberList.do">
								<li><span class="text">회원관리</span> <!-- default 아이콘 --> <span class="icon"><i
											class="fas fa-chevron-left"></i></span> <!-- member_list.jsp / member_view.jsp :: -->
									<!-- <span class="icon"><i class="fas fa-chevron-right"></i></span> -->

								</li>
							</a>
							<a href="adminProductAdd.do">
								<li><span class="text">상품등록</span> <!-- default 아이콘 --> <span class="icon"><i
											class="fas fa-chevron-left"></i></span> <!-- order_list.jsp / order_view.jsp :: -->
									<!-- <span class="icon"><i class="fas fa-chevron-right"></i></span> -->

								</li>
							</a>
							<a href="adminProductList.do">
								<li><span class="text">상품목록</span> <!-- default 아이콘 --> <span class="icon"><i
							...
							<a href="goodsmaster.do">
								<li><span class="text">주문관리</span> <!-- default 아이콘 --> <span class="icon"><i
											class="fas fa-chevron-left"></i></span> <!-- 접속관리 페이지 누락됨 :: -->
									<!-- <span class="icon"><i class="fas fa-chevron-right"></i></span> -->

								</li>
							</a>
							<a href="reviewListManage.do">
								<li><span class="text">리뷰관리</span> <!-- default 아이콘 --> <span class="icon"><i
											class="fas fa-chevron-left"></i></span> <!-- qna_list.jsp / qna_view.jsp :: -->
									<!-- <span class="icon"><i class="fas fa-chevron-right"></i></span> -->
				...
				<div id="btn_manager_wrapper">
					...
					<div id="manager">
						...
						<form action="searchResult.do" method="get" id="searchid">
							...
							<table class="mgr_table verHead" style="text-align: center;">
								<tr>
									<th>제품명</th>
									<td><input name="OrderSearch" value=""> <!-- <input name="p_date1" size="20" value="20191123">
								&nbsp; ~ &nbsp; <input name="OrderSearch" size="20" value="20191223"> -->
										<input id="search_btn" type="submit" value="검색" " name=" OrderSearch" form="searchid">
									</td>
								</tr>
							</table>
						...
						<form name=rFrm id="rFrame" enctype="multipart/form-data" action="changeStatus.do" method="post">
							<table class="mgr_table horHead" style="text-align: center;">
								<tr>
								<tr>
									<td><input class="checkbox" type="checkbox" name="allCh" onclick="allChk()"></td>
								...
								<c:forEach var="order" items="${order}">
									<tr>
										<td><input class="checkbox" type="checkbox" name="delete" value="${order.orderNo}" onclick="chk()">
										</td>
										<td>${order.orderNo}</td>
