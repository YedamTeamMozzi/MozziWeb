	...
	<body>
		<div id="main">
			<div id="btn_manager_wrapper">
				...
				<div id="manager" style="padding: 0;">
					<h1 class="title" style="padding: 30px;">제품 등록</h1>
	            ...
	            대신에 action을 통해서 action="productProc.jsp?flag=insert" 를 해줘야한다.-->
	        		...
	        		<input type="hidden" value="update" name="flag">	-->
						...
						<table class="mgr_table verHead" id="pht_table" style="text-align: center;">
							<tr>
								<th>메인이미지</th>
							...
							<tr>
								<th>상세이미지</th>
								<td><input type="file" name="detailImg" />
								</td>
							</tr>
						</table>
