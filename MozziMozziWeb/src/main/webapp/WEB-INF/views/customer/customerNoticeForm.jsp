		...
		<div class="noticeFormBody">
		  <form action="noticeAdd.do" method="post" id="notice_form">
			<table class="noticeFormTable">
			  ...
			  <tbody class="tableBody">
				<tr>
					...
					<td colspan="2"><input 
						name="notice_title" id="notice_title"type="text"></td>
					<td>관리자</td>
				  </tr>
				<tr>
				  <th>공지내용</th>
				  <td colspan="3"><textarea name="notice_content" id="notice_content" style="width: 100%; height: 450px;"></textarea></td>
				</tr>
			  </tbody>
			  <tfoot>
				<tr>
			...
			<div class="reviewBtn">
			  ...
			  <input class="not_btn" type="button" value="등록취소">
			</div>
		  </form>
		</div>
	  </div>
