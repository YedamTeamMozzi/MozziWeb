  ...
  <div class="qnaBox">
    ...
    <form action="customerQnaUpdate.do" method="post" id="qna_form">
      <table class="qnaTable">
        ...
        <tr class="qnaTr3">
          <th>내용</th>
          <td colspan="2"><textarea class="readChk" name="qna_content" id="qna_content">${vo.qnaContent}</textarea></td>
        </tr>
        <tr class="qnaTrBtn">
          <td></td>
        ...
        <tr class="qnaTrReply">
          <td class="reply1">문의답변 <i class="fa-solid fa-comment fa-lg i_up"></i>
