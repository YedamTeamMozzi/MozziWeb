      ...
      <form action="">
        <div class="qna_contents">
          <div class="font right">
            ...
            <select name="" id="" class="pl ri2">
              <option value="" class="txt">결제</option>
              <option value="" class="txt">배송</option>
              <option value="" class="txt">기타</option>
            </select>
          </div>
          <div class="font">
            ...
            <input type="text" id="qna_user_id" name="qna_user_id" value="박선아">
